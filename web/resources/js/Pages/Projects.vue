<template>
    <div>
        ...
        <div class="min-h-screen bg-center bg-no-repeat bg-cover"
             :style="{
            ...
            <!-- Page Content -->
            <main>
                <div class="flex flex-col w-3/4 ml-auto mr-auto items-center h-auto mt-5">
                    <img :src="$page.props.logo" class="w-full sm:w-3/4 md:w-1/2 lg:w-1/4 xl:w-1/5">
                </div>

                <div
                    class="flex flex-col w-full md:w-1/2 xl:w-1/3  ml-auto mr-auto items-center mt-5 bg-white p-4 rounded-lg shadow-2xl">
                    <div class="flex flex-col w-full items-center bg-white p-2 rounded-lg "
                    ...
                    <div @click="showHistory = !showHistory"
                        ...
                        <div class="text-center w-full">
                            <Headline2 class="mt-3 flex items-center justify-center cursor-pointer">
                                Audit History
                    ...
                    <Audit v-show="showHistory" :audits="audits" context="homePage"></Audit>
