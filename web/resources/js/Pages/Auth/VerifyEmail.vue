...
<template>
    ...
    <AuthenticationCard>
        ...
        <div v-if="verificationLinkSent" class="mb-4 font-medium text-sm text-confirmative">
        ...
        <form v-else @submit.prevent="submit">
            <div class="mt-4 flex items-center justify-between">
                ...
                <Button data-id="sbumitbtn" type="submit" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
