...
<template class="bg-white">
    ...
    <AuthenticationCard>
        ...
        <blockquote class="p-4 my-4 bg-porsche-50 border-l-4 border-porsche-500 text-porsche-900">
            ...
            <ul class="list-disc pl-5 space-y-1">
                ...
                <li>The server might become unavailable, due to updates, maintenance.</li>
                <li>The database, user-interface, functionality, and set features can change at any time and without
                    warning.
                </li>
                ...
                <li>Please do not upload real interview data without consent. Use an LLM to simulate interview data or
                    use public domain text data such as the Gutenberg collection.
                </li>
            </ul>

            <p class="mt-2 font-semibold">
                We will notify you, once this software reaches the Pre-Release Stage and enters a certain level of
                reliability.
            </p>
        </blockquote>
