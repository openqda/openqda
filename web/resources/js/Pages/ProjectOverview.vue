                ...
                <div class="flex space-x-4">
                    ...
                    <div class="w-1/2 my-2">
                        ...
                        <div class="w-full italic text-gray-400 my-4 text-sm">
                            This import is intended for codebook exports that supports <a href="https://www.qdasoftware.org/refi-qda-codebook" title="REFI website" target="_blank" class="text-blue-500 font-bold">REFI</a>.
                            <br>
                            Our goal is to support MaxQDA, NViVo, atlas.ti, f4analyse. If you find a problem, please <a href="mailto:openqda@uni-bremen.de" class="text-blue-500 font-bold">contact us</a>.
                            <br>
                            You can also import codebooks from other projects, but they might not be fully functional.
                        </div>
                        <form
