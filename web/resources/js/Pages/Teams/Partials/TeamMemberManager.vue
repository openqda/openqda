...
<template>
    <div>
                        ...
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button
                                    ...
                                    @click="confirmingMakeOwner = true; makeOwnerForm.user = user;"
                                >
                                ...
                                <button
                                    ...
                                    class="cursor-pointer ml-6 text-sm text-red-700"
        ...
        <ConfirmationModal :show="confirmingMakeOwner" @close="confirmingMakeOwner = false">
            <template #title>
                Change owner of project and team
            </template>

            <template #content>
                You are about to make this person the owner of the project and team. Are you sure you want to do this?
                This is reversible only by the new owner.
            </template>
