  ...
  <div class="divide-y divide-foreground/20">
    ...
    <div class="py-6">
      ...
      <ul class="flex flex-col gap-2 mt-4 overflow-x-scroll">
        ...
        <li v-if="!project.sources?.length" class="py-2 text-foreground/80 tracking-wide">
            No sources have been added to this project yet.
            Go to <Link :href="route('source.index', project?.id)" class="underline">the preparations page</Link> to crete or import new sources.
        </li>
      </ul>
    </div>
