...
const state = reactive({
    sortBy: { id: 0, field: 'name', type: 'string', order: 'asc', label: 'Sort by name ascending' },
})
...
export const useProjects = () => {
    ...
    const sortOptions = [
        { id: 0, field: 'name', type: 'string', order: 'asc', label: 'Sort by name ascending' },
        { id: 1, field: 'name', type: 'string', order: 'desc', label: 'Sort by name descending' },
        { id: 3, field: 'updated_at', type: 'date', order: 'desc', label: 'Sort by newest update' },
        { id: 2, field: 'updated_at', type: 'date', order: 'asc', label: 'Sort by oldest update' },
    ]
