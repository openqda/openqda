<template>
    <AppLayout>
        ...
        <div
            class="flex flex-col w-full h-screen pt-5 ml-auto mr-auto lg:w-3/4"
        >
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    ...
                                    contenteditable="true"
                                    @keydown.enter="
                                        updateProject('description', $event)
                                    "
                                >
                                    {{ project.description }}
                                </span>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex flex-shrink-0 ml-4 space-x-4"
                                        >
                                            <button
                                                type="button"
                                                @click="deleteProject"
            ...
            <div v-show="currentSubView === 'codebooks'" class="space-y-4">
                ...
                <div>
                    ...
                    <ul v-if="project.codebooks.length > 0" role="list"
                        class="mt-3 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
                        <li v-for="codebook in project.codebooks" :key="codebook.name"
                            class="col-span-1 flex flex-col relative">
                            <Codebook :codebook="codebook" @delete="deleteCodebookFromArray(codebook)"></Codebook>
                        </li>
                    </ul>
                    <div v-else>
                ...
                <div>
                    ...
                    <ul v-if="userCodebooks.length > 0" role="list"
                        class="mt-3 grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
                        <li v-for="codebook in userCodebooks" :key="codebook.name"
                            class="col-span-1 flex flex-col relative">
                            <Codebook :codebook="codebook" :public="true"
                                      @importCodebook="importCodebook(codebook)"></Codebook>
                        </li>
                    </ul>
                    <div v-else>
                        <p class="text-sm text-gray-500">No codebooks from other projects available</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    />
                    <ul v-if="filteredPublicCodebooks.length > 0" role="list"
                        class="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4">
                        <li v-for="codebook in filteredPublicCodebooks" :key="codebook.name"
                            class="col-span-1 flex flex-col relative">
                            <Codebook :codebook="codebook" :public="true"
                                      @importCodebook="importCodebook(codebook)"></Codebook>
                        </li>
