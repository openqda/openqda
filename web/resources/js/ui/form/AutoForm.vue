...
<template>
  <form :id="props.id" class="bg-transparent" @submit="validateForm">
    <component
    ...
    <div v-if="showSubmit !== false || showCancel !== false" class="w-100">
      <CancelButton @click="$emit('cancel')"> Cancel </CancelButton>
      <SubmitButton class="float-right"> Submit </SubmitButton>
    </div>
