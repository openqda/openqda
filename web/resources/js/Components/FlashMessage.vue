<template>
  ...
  >
    <div class="bg-cerulean-500 border-l-4 border-cerulean-700 text-white w-full p-2 shadow-md ">
      {{ flash.message }}
    </div>
    <div class="border-l-4 border-cerulean-700 bg-cerulean-500 h-1 transition-all duration-100" :style="{ width: `${widthPercentage}%` }"></div>
  </div>
</template>
