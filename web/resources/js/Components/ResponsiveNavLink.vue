...
const classes = computed(() => {
  return props.active
    ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-cerulean-500 text-left text-base font-medium text-cerulean-700 bg-cerulean-50 focus:outline-none focus:text-cerulean-800 focus:bg-cerulean-100 focus:border-cerulean-700 transition duration-150 ease-in-out'
